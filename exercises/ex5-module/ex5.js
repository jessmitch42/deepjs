var App = (function createApp() {
	...
	// to make these functions available externally
	// the benefit is preventing all the code below from being globally available. only the parts required to be exposed are now
	return api;
